...
_SETTINGS: Dict[str, SettingSpec] = {
    ...
    "optimal_pairs_rebalance_enabled": SettingSpec(
        key="optimal_pairs_rebalance_enabled",
        section="trading",
        parser=_parse_required_bool,
        serializer=_serialize_bool,
        default=True,
        env_var="OPTIMAL_PAIRS_REBALANCE_ENABLED",
    ),
    "optimal_pairs_refresh_hours": SettingSpec(
        key="optimal_pairs_refresh_hours",
        section="trading",
        parser=_parse_positive_int,
        serializer=_serialize_int,
        default=8,
        env_var="OPTIMAL_PAIRS_REFRESH_HOURS",
        validators=(_validate_positive("optimal_pairs_refresh_hours"),),
    ),
    "optimal_pairs_top_n": SettingSpec(
        key="optimal_pairs_top_n",
        section="trading",
        parser=_parse_positive_int,
        serializer=_serialize_int,
        default=10,
        env_var="OPTIMAL_PAIRS_TOP_N",
        validators=(_validate_positive("optimal_pairs_top_n"),),
    ),
    "optimal_pairs_signal_max_age_minutes": SettingSpec(
        key="optimal_pairs_signal_max_age_minutes",
        section="trading",
        parser=_parse_positive_int,
        serializer=_serialize_int,
        default=120,
        env_var="OPTIMAL_PAIRS_SIGNAL_MAX_AGE_MINUTES",
        validators=(_validate_positive("optimal_pairs_signal_max_age_minutes"),),
    ),
    "optimal_pairs_scan_limit": SettingSpec(
        key="optimal_pairs_scan_limit",
        section="trading",
        parser=_parse_positive_int,
        serializer=_serialize_int,
        default=400,
        env_var="OPTIMAL_PAIRS_SCAN_LIMIT",
        validators=(_validate_positive("optimal_pairs_scan_limit"),),
    ),
